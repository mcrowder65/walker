...
public class ZoningTools {
	...
	public static int GetTimeZone(LatLng coord)
	{
		...
		String resp = Tools.getHTTPString("https://maps.googleapis.com/maps/api/timezone/json?location=" + coord.toUrlValue() +"&key=" + Config.TIMEZONE_KEY +"&timestamp=" + TIMESTAMP);
	...
	public static int GetHour(LatLng coord)
	{
		...
		int hour = (time.get(Calendar.HOUR_OF_DAY) + 1) % 24; //Mountain time
