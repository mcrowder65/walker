...
public class Config {
	...
	public static final int MAPS_BACKGROUND_RGB = -1776417; //TAN
	public static final int MAPS_GRASS_RGB = -3479901; //GREEN
	public static final int MAPS_NORMALPATH_RGB = -1; //WHITE
	public static final int MAPS_BUILDING_RGB = -65536; //RED
